...
def generate_gps_data(device_id, timestamp, vehicle_tye='private'):
    return {
        'id': uuid.uuid4(),
        'deviceId': device_id,
        'timestamp': timestamp,
...
def simulate_journey(producer, device_id):
    while True:
        ...
        weather_data = generate_weather_data(device_id, vehicle_data['timestamp'], 'Nikon-Cam123')
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f'Simulation ended by user: {e}')
